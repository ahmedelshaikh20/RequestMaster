...
object RequestsTable {
  ...
  //Table Creation
  val CREATE_TABLE =
    "CREATE TABLE $TABLE_NAME ($ID INTEGER PRIMARY KEY , $REQUEST_TYPE TEXT , $REQUEST_URL TEXT,$REQUEST_BODY TEXT , $REQUEST_HEADERS TEXT ,$QUERY_PARAMETERS TEXT ,$RESPONSE_STATUS TEXT , $RESPONSE_BODY TEXT , $RESPONSE_HEADERS TEXT , $EXECUTION_TIME TEXT,$RESPONSE_STATUS_CODE Int ,$ERROR TEXT)"
  // Drop Table
